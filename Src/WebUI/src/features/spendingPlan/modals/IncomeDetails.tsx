...
function IncomeDetails({income}: Props) {

  return (
    <Container fluid>
      <Header as={'h2'} content='Income Details' textAlign='center' />
      ...
      <Grid.Row style={{marginBottom: '10px'}}>
          ...
          <Grid.Column width={8}>
            <Header as={'h4'} content= {`${income.category}`} />
          </Grid.Column>
        </Grid.Row>        
        <Grid.Row style={{marginBottom: '10px'}}>
          <Grid.Column width={8}>
          ...
          <Grid.Column width={8}>
            <Header as={'h4'} content= {`${income.completedAmount}`} />
          </Grid.Column>
        </Grid.Row>
        <Grid.Row style={{marginBottom: '10px'}}>
          <Grid.Column width={8}>
          ...
          <Grid.Column width={8}>
            <Header as={'h4'} content= {`${income.amount}`} />
          </Grid.Column>
        </Grid.Row>
        <Grid.Row style={{marginBottom: '10px'}}>
          <Grid.Column width={8}>
          ...
          <Grid.Column width={8}>
            <Header as={'h4'} content= {`${income.accountName}`} />
          </Grid.Column>
        </Grid.Row>
        <Grid.Row style={{marginBottom: '10px'}}>
          <GridColumn width={8}>
          ...
          <Grid.Column width={8}>
            <CircleProgress progress={income.completedAmount / income.amount} />
          </Grid.Column>
        </Grid.Row>
      </Grid>
      <Container fluid style={{height: '200px', width: '100%', overflow: 'auto'}}>
        <Table celled fixed style={{borderRadius: '25px', width: '100%'}}>
          ...
          <Table.Body>
            {income.completedIncomes.map((transaction, index) => (
              <Table.Row key={index}>
