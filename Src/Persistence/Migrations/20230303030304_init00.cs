        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompletedAmount = table.Column<double>(type: "REAL", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FutureSavings", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Category = table.Column<string>(type: "TEXT", nullable: true),
                    AccountId = table.Column<Guid>(type: "TEXT", nullable: false),
                    FutureTransactionId = table.Column<Guid>(type: "TEXT", nullable: true),
                    BudgetId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.FutureTransactionId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FutureSavingId = table.Column<Guid>(type: "TEXT", nullable: true),
                    BudgetId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FutureSavings_BudgetId",
                table: "FutureSavings",
                column: "BudgetId");

            migrationBuilder.CreateIndex(
                name: "IX_FutureSavings_FromAccountId",
                table: "FutureSavings",
                column: "FromAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_FutureSavings_GoalId",
                table: "FutureSavings",
                column: "GoalId");

            migrationBuilder.CreateIndex(
                name: "IX_FutureSavings_ToAccountId",
                table: "FutureSavings",
                column: "ToAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_FutureTransactions_AccountId",
                table: "FutureTransactions",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_FutureTransactions_BudgetId",
                table: "FutureTransactions",
                column: "BudgetId");
